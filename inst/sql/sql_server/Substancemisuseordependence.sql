...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (440069,4279309,37116660,440787,378726,443274,37116661,4217840,433735,432609,44786481,434697,4296409,4302387,2796056,44790195,4149607,4219382,44788279,4269905,44787894,4275257,4004672,44788303,4151569,4319165)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (440069,4279309,37116660,440787,378726,443274,37116661,4217840,433735,432609,44786481,434697,4296409,4302387,2796056,44790195,4149607,4219382,44788279,4269905,44787894,4275257,4004672,44788303,4151569,4319165)
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2015, 12, 31) and C.condition_start_date <= DATEFROMPARTS(2019, 12, 31))
...
WHERE (C.observation_date >= DATEFROMPARTS(2015, 12, 31) and C.observation_date <= DATEFROMPARTS(2019, 12, 31))
...
WHERE (C.procedure_date >= DATEFROMPARTS(2015, 12, 31) and C.procedure_date <= DATEFROMPARTS(2019, 12, 31))
